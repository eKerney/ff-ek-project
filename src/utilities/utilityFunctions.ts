...
export const getWindDirection = (wind: number): string => {
...
export const parseData = (res: any, fetchType: FetchTypes, transformData: AirportData | WeatherData): AirportData | WeatherData => {
  switch (fetchType) {
    case "AIRPORT_INFO":
      return {
        id: res.faaCode,
